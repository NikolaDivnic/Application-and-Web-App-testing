...
public class ShuffleGame extends JFrame implements ActionListener
{
    ...
    public boolean dohvatiStanjeDugmica(){
    	return buttonA[0].isEnabled();
    }
    ...
    public static ShuffleGame dohvatiShufle(){
    	return shuffleGame_;
    }
    public boolean dohvatiStatusIgre(){
    	return gameStatus;
    }
    ...
    public int dohvatiBrojKomponenti(){
        return getContentPane().countComponents();
    }
    public SecondsCounter brojacSekundi(){
    ...
    public void posaljiSignal(boolean f){
    	fleg = f;
    }
    ...
    public void postaviMatricu(int[]niz,int duzina){
    ...
    public int nadjiPrazno(int broj){
    ...
    public Component dohvatiButtonPanel(int broj){
    	return buttonPanel.getComponent( broj ) ;
    }
